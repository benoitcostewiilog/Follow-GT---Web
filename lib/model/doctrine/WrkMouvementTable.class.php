...
class WrkMouvementTable extends Doctrine_Table {
    ...
    private function addQueryRecherche($req, $value) {
        if ($value) {
            $req->andWhere("(m.ref_produit LIKE '%$value%' OR p.ref_produit LIKE '%$value%' OR m.type LIKE '%$value%' OR e.libelle LIKE '%$value%' OR m.commentaire LIKE '%$value%' OR m.groupe LIKE '%$value%' OR  m.heure_prise LIKE '%$value%' OR  u.username LIKE '%$value%')");
        }
