 ...
 * @method sfGuardUserPermission setUser_id()       Sets the current record's "user_id" value
 * @method sfGuardUserPermission setPermission_id() Sets the current record's "permission_id" value
