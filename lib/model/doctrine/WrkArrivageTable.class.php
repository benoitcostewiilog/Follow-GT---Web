...
class WrkArrivageTable extends Doctrine_Table {
    ...
    public function getArrivages($heureDebut = '', $heureFin = '', $fournisseur = '', $transporteur = '', $statut = '', $produit = '', $urgent = '') {
    ...
    public function checkNumArrivageUnique($numArrivage) {
      ...
      /**
     * 
     * @param WrkArrivage $arrivage
     * @return boolean
     */
    public function envoiMailContactPFF($arrivage) {
        
         //A decommenter en PROD
      $emails = array($arrivage->getRefContactPFF()->getMail());
        ...
        $message="<p>Bonjour,</p><p>Votre colis suivant est arrivé,</p><br><br>"; 

        $message.="Numéro d'arrivage : ".$numArrivage."<br>";
        $message.="Intitulé fournisseur : ".$arrivage->getRefFournisseur()->getLibelle()."<br>";
          $message.="N° tracking fournisseur : ".$arrivage->getTrackingFour()."<br>";
            $message.="N° commande d'achat : ".$arrivage->getCommandeAchat()."<br>";
              $message.="Horodatage de l'arrivage : ".DateTime::createFromFormat('Y-m-d H:i:s', $arrivage->getCreatedAt())->format('d/m/Y H:i:s')."<br><br><br>";
            $message.="<p>Il sera disponible dans votre Drop Zone à partir de 16h00.<p><p>Merci,</p><p>L’équipe GT Logistics</p>";
               try {
        $mail = Swift_Message::newInstance()
                ...
                ->setBody(self::getBodyMail("", $message));
     ...
     * @return boolean
     */
    public function envoiMail($arrivage) {
        
         //A decommenter en PROD
      $emails = array($arrivage->getRefInterlocuteur()->getMail());
        ...
        $titre.="Arrivage urgent";
        $message="<p>Bonjour,</p><p>Votre commande urgente suivante est arrivée,</p><br><br>"; 
        ...
        $message.="Intitulé fournisseur : ".$arrivage->getRefFournisseur()->getLibelle()."<br>";
          $message.="N° tracking fournisseur : ".$arrivage->getTrackingFour()."<br>";
            $message.="N° commande d'achat : ".$arrivage->getCommandeAchat()."<br>";
              $message.="Horodatage de l'arrivage : ".DateTime::createFromFormat('Y-m-d H:i:s', $arrivage->getCreatedAt())->format('d/m/Y H:i:s')."<br><br><br>";
        $message.="<p>La réception de cette commande sera effectuée sous deux heures.</p><p>Merci,</p><p>L’équipe GT Logistics</p>";
