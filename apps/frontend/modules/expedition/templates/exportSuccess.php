...
<body onload="checkPrint()">
    ...
    <table style="width:100%;margin-left:4px;">
        <tr>
            ...
            <td><h1  style="font-size:13pt;">Historique des expeditions</h1></td>
        </tr>
    </table>
    <br/>
    ...
    <table style="width:100%;">
        ...
        <tbody>
            ...
            <table style="width:100%;">
                ...
                <tr >
                    <!--<td class="click"><?php echo ($expedition->getRefFournisseur() ? $expedition->getRefFournisseur()->getLibelle() : $expedition->getIdFournisseur()) ?></td>-->
                    ...
                    <td><?php echo $expedition->getLettreVoiture() ?></td>
                    <td><?php echo $expedition->getNbColis() ?></td>
                    <td><?php echo $expedition->getImmatriculation() ?></td>
                    <!--<td><?php echo $expedition->getStatut() ?></td>-->
                    <td><?php echo $expedition->getCreatedAt() ?></td>
                </tr>
