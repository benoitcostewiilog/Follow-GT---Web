...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input  type="text" id="date_livraison_debut" name="date_livraison_debut" class="form-control dateHeure date_livraison_debut"  value="<?php echo isset($urgence) && $urgence->getDateLivraisonDebut() ? DateTime::createFromFormat('Y-m-d H:i:s', $urgence->getDateLivraisonDebut())->format('d/m/Y H:i:s') : ''; ?>" />
        <input  type="text" id="date_livraison_fin" name="date_livraison_fin" class="form-control dateHeure date_livraison_fin" value="<?php echo isset($urgence) && $urgence->getDateLivraisonFin() ? DateTime::createFromFormat('Y-m-d H:i:s', $urgence->getDateLivraisonFin())->format('d/m/Y H:i:s') : ''; ?>" />
    </div>
</div>
...
<script>
    ...
    var dateMax='<?php $date = date("Y-m-d H:i:s");
           ...
           $date->modify('+1 day');
           echo $date->format('d/m/Y')." 00:00:00";
           ?>'
