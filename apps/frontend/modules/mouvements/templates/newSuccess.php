<div class="wrapper wrapper-content animated fadeInRight">
    <div id="tpltEdtHrchy" class="hidden">
        <ol class="breadcrumb">
            ...
            <li>
                <a onclick="goBack();"><?php echo __(' Mouvements'); ?></a>
            </li>
            <li class="active">
                <strong><?php echo __('Créer un mouvements'); ?></strong>
            </li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo __('Formulaire de création d\'un mouvements'); ?></h5>
                </div>
                <div class="ibox-content">
                    <form method="POST" action="<?php echo url_for(array('sf_route' => 'mouvements-create')) ?>" id="formNew" class="form-horizontal">
                       <?php include_partial('form',array('types'=>$types,'emplacements'=>$emplacements,'users'=>$users)) ?>
