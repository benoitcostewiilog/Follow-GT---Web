<div class="ibox-content">
    ...
    <div class="text-center">
        <h3>
            ...
            <?php echo $jour.'/'. $mois ?>/<?php echo $annee ?>
...
?>
        ...
        $('#precedent-volumetrie-arrivage').click(function () {
            $.ajax({
                url: '<?php echo url_for('acceuil-reload-stats') ?>?type=volumetrie-arrivage&annee=<?php echo $annee ?>&mois=<?php echo $mois+0 ?>&jour=<?php echo $jour - 1 ?>',
