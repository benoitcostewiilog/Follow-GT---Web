            ...
            ?>
                        <div class="col-md-6">
                            <div class="ibox float-e-margins" id="reception">
                                <?php include_partial('nbColisParJour', array('nbColisParMois' => $nbColisReceptionParMois, 'titre' => 'Réceptions (Nb de réceptions SAP)', 'id' => 'reception', 'annee' => $annee, 'mois' => $mois, 'jour'=>$jour)); ?>
                            </div>
