...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('class_select', 'form-control double_list_select');
    $this->addOption('associated_first', true);
    $this->addOption('label_unassociated', 'Interdit');
    $this->addOption('label_associated', 'Autorisé');
...
<div class="%class%">
  <div style="float: left">
    <div style="float: $float">
      <div class="double_list_label champ">%label_associated%</div>
      %associated%
    </div>
    <div style="float: $float; margin-top: 4em; margin-right:2em; margin-left:2em">
      %associate%
      <br />
	  <br />
	  <br />
    ...
    <div style="float: $float">
      <div class="double_list_label champ">%label_unassociated%</div>
      %unassociated%
    </div>
  </div>
  <br style="clear: both" />
