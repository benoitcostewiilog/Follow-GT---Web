...
// date: 2019/01/18 11:18:13
  ...
  'cache_dir' => 'C:\\wamp64\\www\\FollowGT\\GT-SED\\FollowGTFluxWeb\\cache\\frontend\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\wamp64\\www\\FollowGT\\GT-SED\\FollowGTFluxWeb\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\wamp64\\www\\FollowGT\\GT-SED\\FollowGTFluxWeb\\cache\\frontend\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\wamp64\\www\\FollowGT\\GT-SED\\FollowGTFluxWeb\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mobile-tracking.fr',
      'port' => 25,
      'encryption' => NULL,
      'username' => 'noreply@mobile-tracking.fr',
      'password' => 'Hh1e_73q',
    ),
  ),
))));
